document.addEventListener('DOMContentLoaded', () => {
    ...
    function showView(viewName) {
        [landingView, mainView, cashView, travelView].forEach(v => v?.classList.add('hidden'));
        ...
        window.travelData.forEach(dest => {
            ...
            card.innerHTML = `
                <div class="dest-image" style="background-image: url('${dest.image}')">
                    <div class="dest-date">${dest.date}</div>
                </div>
                <div class="dest-info">
                    <div>
                    ...
                    <div class="dest-footer">
                        ...
                        <button class="action-btn-pill">Details</button>
                    </div>
                </div>
            `;
    ...
    document.addEventListener('click', (e) => {
        if (e.target.closest('.delete-avatar')) {
            window.removePerson(e.target.closest('.delete-avatar').dataset.id);
        }
